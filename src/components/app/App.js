...
class App extends React.Component {
  ...
  handleNext = () => {
    ...
    if (this.state.isPlaying === true) {
      this.state.sound[this.state.index].stop(); //stops song
      this.state.index === this.state.musics.length - 1 //handles index
        ? this.setState({
            index: 0,
            playLabel: "play_circle_outline",
            isPlaying: false,
  ...
  handleBack = () => {
    if (this.state.isPlaying === true) {
      this.state.sound[this.state.index].stop();
      this.setState({
  ...
  handlePlay = () => {
    ...
    if (this.state.isPlaying === false) {
      this.state.sound[this.state.index].play();
      this.setState({
        playLabel: "pause_circle_outline",
      });
    } else if (this.state.isPlaying === true) {
      this.state.sound[this.state.index].pause();
      this.setState({
        playLabel: "play_circle_outline",
      });
    }
  ...
  render() {
    return (
      <div className="App">
        <Controls
          playLabel={this.state.playLabel}
        ...
        <section className="player__top-section">
          ...
          <div className="player__icon-wrap">
            ...
            <a href="" className="player__icon-link player__icon-link--active">
              <i className="material-icons player__icon">repeat</i>
            </a>
            <a href="" className="player__icon-link">
