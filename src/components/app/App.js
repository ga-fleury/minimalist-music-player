      ...
      <main className="player-bg">
        <section className="player__top-section">
          ...
          <div className="player__icon-wrap">
            <i className="player__icon material-icons">open_in_new</i>
            <i className="player__icon material-icons">repeat</i>
            <i className="player__icon material-icons">shuffle</i>
            <svg
        ...
        <div className="player__info-wrap">
          ...
          <div className="music__btn-wrap">
            ...
            <i className="music__btn material-icons">play_circle_outline</i>
